...
class BrokerServiceTest extends AbstractBaseTest {
    ...
    void init() {
        ...
        brokerService = new BrokerService(new MetricsCache(), adminClientService, new DescribeLogDirsMapper(), new ClusterMapperImpl());
    }
    ...
    void getBrokersEmpty() {
        assertThatThrownBy(() -> brokerService.getBrokers(KafkaCluster.builder().build())).isInstanceOf(NullPointerException.class);
    }
