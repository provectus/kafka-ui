...
public abstract class AbstractBaseTest {
  ...
  public static class Initializer
    ...
    public void initialize(@NotNull ConfigurableApplicationContext context) {
      ...
      System.setProperty("kafka.clusters.0.schemaRegistry.url", schemaRegistry.getUrl());
      ...
      System.setProperty("kafka.clusters.1.schemaRegistry.url", schemaRegistry.getUrl());
