...
public class OAuthSecurityConfig extends AbstractAuthSecurityConfig {
  ...
  private ClientRegistrationModel mapClientRegistration(final ClientRegistration cr) {
    ...
    return new ClientRegistrationModel(
        ...
        REACTIVE_CLIENT_REGISTRATION_REPOSITORY_CLASSNAME.formatted(provider.getProvider().toLowerCase()),
        REACTIVE_CLIENT_REGISTRATION_REPOSITORY_CLASSNAME.formatted(cr.getRegistrationId())
    );
  }
}
