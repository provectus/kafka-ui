...
describe('TopicTable Components', () => {
  ...
  describe('with topics', () => {
    it('renders correct rows', () => {
      ...
      expect(
        screen.getByRole('row', { name: '__internal.topic 1 0 1 0 Bytes Bytes 0 0 0 0 0 0 0 Bytes' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('link', { name: 'external.topic' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('row', { name: 'external.topic 1 0 1 0 KB KB 0 0 0 0 0 0 0 1 KB' })
      ).toBeInTheDocument();
