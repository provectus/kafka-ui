...
|`KAFKA_CLUSTERS_0_KAFKACONNECT_0_USERNAME`| Connect cluster's basic authentication username
|`KAFKA_CLUSTERS_0_KAFKACONNECT_0_PASSWORD`| Connect cluster's basic authentication password
